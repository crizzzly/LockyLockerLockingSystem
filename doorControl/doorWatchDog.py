...
email = 'prototyping.hfg@gmail.com'
password = 'prototyping@hfg'

if __name__ == "__main__":
    #runs the main door control program in a try catch and restarts the pi if the main program ever crashes
    db=MySQLdb.connect(host="localhost", user="doorAccess", passwd="password", db="doorMaster")
    ...
    #send reboot message
    server.sendmail(email, sendArray, msg)
    server.quit()
